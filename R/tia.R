...
# assign random variable V, binary tx variable D if less than 0 assigned to tx group, if greater assigned to control
v <- rnorm(bigN, 0, 2)
...
# use sumtable function, regress outcome on binary tx - won't be unbiased est
...
#ydiff = delta for x, w_ATE # of obs for rows, w_ATT = weights
TIA_table <- TIA_DATA %>%
...
# n_obs_0 decreases as # grows, n_obs_1 increases
#Y_mean_0, etc avg tx effect 
